          ...
          <div className="grid gap-10 md:grid-cols-[2fr_1fr]">
            <div className="space-y-6 text-lg leading-8">
              ...
              <p>
                ...
                fought my whole life for my mother, my brother, my sister, and
                my grandmother.
              </p>
              ...
              <p>
                ...
                I wanted to explore my identity and my connection to the world.
                That journey took me from the UK to Japan, Australia, New Zealand,
                Hong Kong, and eventually Canada.
              </p>

              <p>
                I have faced joblessness, discrimination, grief, housing
                insecurity, and food insecurity. These experiences shaped my
                belief that politics must be grounded in compassion, dignity, and
              ...
              <p>
                I enjoy hiking and landscape photography, and I am grateful for
                the land, water, and air we depend on. That gratitude also makes
                me deeply aware of the climate emergency we face.
              </p>

              <p>
                I believe in strong public services, grassroots democracy, union
                rights, climate responsibility, and building a politics that
